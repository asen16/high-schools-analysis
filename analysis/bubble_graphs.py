...
from graph_design import font, color_discrete_sequence_bubble, title_font_size
#call data from data_filtering
from data_filtering import highschool, provinces
...
#High School Factor Bubble Graph
...
fig.write_html(graph_location+'high_school_exam_bubble.html', auto_open=auto_open)
#create pdf type graph
fig.write_image(graph_location+"high_school_exam_bubble.pdf")
